...
<html>
  ...
  <body>
      <h4>快捷通即时到账交易网关接口测试页面</h4>
      
      <span class="red">
   		使用步骤：<br>
   		1.如有分账信息，点击[添加分账信息]按钮将分润账号集列表参数放入分润账号集列表(royalty_info)参数中<br>
   		2.点击[添加交易信息]按钮将交易详细信息参数放入交易信息(trade_info)参数中<br>
   		3.点击[加密业务参数并设置到请求参数集合中]按钮将业务参数加密后放入请求参数集合(biz_content)参数中<br>
   		4.点击[提交支付]按钮将请求参数提交到快捷通网关
   	  </span>
      ...
      <form id="form" action="https://zgateway.kjtpay.com/recv.do" method="post">
		...
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				<td>接口名称:</td>
				<td><input type="text" id="service" name="service" value="instant_trade"></td>
				<td>(例如：instant_trade，非空)</td>
			</tr>
			<tr>
				<td>接口版本:</td>
	...
	<div id='bizContentDiv'>
		<table border="1px;" cellspacing="0px;" cellpadding="0px;" width="100%">
			...
			<tr>
				<td>业务产品码:</td>
				<td><input type="text" name="biz_product_code" value='20601'></td>
				<td>(取值参考接口文档，非空)</td>
			</tr>
			<tr>
				<td>收银台类型:</td>
